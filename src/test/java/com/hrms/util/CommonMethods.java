...
public class CommonMethods extends PageInitializer{
    ...
    public static WebDriverWait getWait(){
        WebDriverWait wait=new WebDriverWait(driver, com.hrms.util.Constants.EXPLICIT_WAIT);
        return wait;
    }
    ...
    public static byte[] takeScreenshot(String fileName){
        ...
        try {
            FileUtils.copyFile(sourceFile, new File(com.hrms.util.Constants.SCREENSHOT_FILEPATH + fileName + getTimeStamp("yyyy-MM-dd-HH-mm-ss")+".png"));
        }catch (IOException e){
            e.printStackTrace();
        }
